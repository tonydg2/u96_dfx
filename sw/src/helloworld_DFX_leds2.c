...
#define PL_REG32_2_ADDR 0xa0010000
...
int main()
{
    ...
    while (1) {
      ...
      if (Ch == '0') {
        ...
        Xil_Out32(PL_REG32_2_ADDR + 0x1C,0x0);
      } else if (Ch == 'b') {
        Xil_Out32(PL_REG32_2_ADDR + 0x1C,0x1);
      } else if (Ch == 'c') {
        Xil_Out32(PL_REG32_2_ADDR + 0x1C,0x2);
      } else if (Ch == 'd') {
        val = Xil_In32(PL_REG32_2_ADDR + 0xC);
        xil_printf("Val = %x\n\r",val);
        val = Xil_In32(PL_REG32_2_ADDR + 0x10);
        xil_printf("Val = %x\n\r",val);
      } else if (Ch == 'e') {
        Xil_Out32(PL_REG32_ADDR + 0x18,0x1);
      } else if (Ch == 'f') {
        Xil_Out32(PL_REG32_ADDR + 0x18,0x0);
      }
    }
    xil_printf("\n\r----------------------------------------\n\r");
    xil_printf("** END **\n\r");
