...
################################################################
# This is a generated script based on design: led_bd2
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [list \
    CONFIG.CONST_VAL {0xA} \
    CONFIG.CONST_WIDTH {5} \
  ] $xlconstant_0


  # Create port connections
  connect_bd_net -net clk100_0_1 [get_bd_ports clk100] [get_bd_pins led_cnt_wrapper_0/clk100]
  connect_bd_net -net led_cnt_wrapper_0_led_o [get_bd_pins led_cnt_wrapper_0/led_o] [get_bd_ports led_o]
  connect_bd_net -net rst_0_1 [get_bd_ports rst] [get_bd_pins led_cnt_wrapper_0/rst]
